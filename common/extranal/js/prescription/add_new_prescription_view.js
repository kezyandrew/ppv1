...
$(document).ready(function () {
    ...
    $.each($('select.medicinee option:selected'), function () {
        ...
        if ($('#med_id-' + id).length) {
            ...
            $(".medicine").append('<section id="med_selected_section-' + med_id + '" class="med_selected col-md-5">\n\
         <div class = "form-group medicine_sect col-md-2"><div class=col-md-12>\n\
<label> <?php echo lang("medicine"); ?> </label>\n\
</div>\n\
\n\
<div class=col-md-12>\n\
<input class = "medi_div" style="font-weight: bold;" readonly name = "med_id[]" value = "' + med_name + '" placeholder="" required>\n\
    ...
    $(".medicine_div").on("change", ".medicinee", function () {
        ...
        $.each($('select.medicinee option:selected'), function () {
            ...
            if ($('#med_id-' + id).length) {
                ...
                $(".medicine").append('<section class="med_selected col-md-5" id="med_selected_section-' + med_id + '">\n\
         <div class = "form-group medicine_sect col-md-2"><div class=col-md-12>\n\
<label> <?php echo lang("medicine"); ?> </label>\n\
</div>\n\
\n\
