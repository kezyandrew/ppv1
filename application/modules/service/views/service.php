                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><?php echo lang('All the service names for frontend website'); ?></h3>
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($services as $service) { ?>
                                        <tr class="">
                                            ...
                                            <td class="no-print">
                                                <button type="button" class="btn btn-primary btn-sm btn_width editbutton" title="<?php echo lang('edit'); ?>" data-toggle="modal" data-id="<?php echo $service->id; ?>"><i class="fa fa-edit"> </i></button>
