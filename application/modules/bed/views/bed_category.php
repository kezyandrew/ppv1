<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><?php echo lang('bed_categories') ?></h1>
                </div>
                <div class="col-sm-6">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($categories as $category) { ?>
                                        <tr class="">
                                            ...
                                            <td class="no-print">
                                                <button type="button" title="<?php echo lang('edit'); ?>" class="btn btn-primary btn-sm btn_width editbutton" data-toggle="modal" data-id="<?php echo $category->id; ?>"><i class="fa fa-edit"></i> </button>
