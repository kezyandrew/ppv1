...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><?php echo lang('admission'); ?> <?php echo lang('details'); ?> | <?php echo $patient->name; ?></h1>
                </div>
                <div class="col-sm-6">
                                        ...
                                        <div class="card pr-3 pl-3">
                                            <div class="tab-content">
                                                        ...
                                                        <div>
                                                            <form role="form" action="" id="editDailyProgress" class="clearfix" method="post" enctype="multipart/form-data">
                                                                ...
                                                                <div class="form-group col-md-12">
                                                                    ...
                                                                    <input type="text" id="date2" class="form-control timepicker-default1 rounded" name="time" id="exampleInputEmail1" value='' placeholder="" required="">
                                                                </div>
                                                                <div class="form-group col-md-12">
                                                ...
                                                <div id="medicines" class="tab-pane">
                                                    <div class="">
                                                        <div class="col-md-12 float-right save_button_div">
                                                                    ...
                                                                    <?php foreach ($daily_medicine as $medicine) { ?>
                                                                        <tr id="<?php echo $medicine->id; ?>">
                                                                            ...
                                                                            <?php if ((empty($allotment->d_time)  && empty($medicine->payment_id)) || $this->ion_auth->in_group(array('admin'))) { ?>
                                                                                <td class="no-print" id="delete-<?php echo $medicine->id; ?>"><button type='button' class='btn btn-danger btn-sm btn_width delete_medicine' title='<?php echo lang('delete'); ?>' data-toggle='' data-id="<?php echo $medicine->id; ?>"><i class='fa fa-trash'></i></button></td>
                                                                            <?php } ?>
                                                                        </tr>
                                                                    <?php } ?>
                                                                </tbody>
                                                                ...
                                                                <form role="form" action="" id="editMedicine" class="clearfix" method="post" enctype="multipart/form-data">
                                                                    ...
                                                                    <div class="form-group col-md-12 row">
                                                                        ...
                                                                        <input type="hidden" id="alloted" name="alloted_bed_id" value="<?php
                                                                                                                                        ...
                                                                                                                                        ?>">
                                                                        <div class="col-md-2">
                                                                            <button type="submit" name="submit" class="btn btn-sm btn-info float-right block_content"><i class="fa fa-save"></i></button>
                                                                        </div>
                                                                    </div>
                                                                </form>
                                                            </div>
                                                ...
                                                <div id="services" class="tab-pane">
                                                    <div class="">
                                                        <div class="col-md-12 float-right save_button_service_div">
                                                            <button id="save_button_service" type="submit" name="submit" class="btn btn-sm btn-info float-right"><i class="fa fa-save"></i> <?php echo lang('save'); ?></button>
                                                        </div>
                                                        <div class="adv-table editable-table ">
                                                                ...
                                                                <tbody id="paservice_table">
                                                                    ...
                                                                    ?>
                                                                            <tr id="<?php echo $service->date; ?>-<?php echo $service->service; ?>">
                                                                                ...
                                                                                <?php if (empty($allotment->d_time) || $this->ion_auth->in_group(array('admin'))) { ?>
                                                                                    <td class="no-print" id="delete-service-<?php echo date('d') . '-' . $service->id; ?>"><button type='button' class='btn btn-danger btn-sm btn_width delete_service' title='<?php echo lang('delete'); ?>' data-toggle='' data-id="<?php echo $service->id . "**" . $service->service; ?>"><i class='fa fa-trash'></i></button></td>
                                                                                <?php } ?>
                                                                            </tr>
                                                                    <?php
                                                                        }
                                                ...
                                                <div id="diagnostic" class="tab-pane">
                                                    <div class="">
                                                        <div class="col-md-12 float-right save_button_diagnostic_div">
                                                            <button id="save_button_diagnostic" type="submit" name="submit" class="btn btn-sm btn-info float-right"><i class="fa fa-save"></i> <?php echo lang('save'); ?></button>
                                                        </div>
                                                        <div class="adv-table editable-table ">
                                                                ...
                                                                <tbody id="diagnostic_table">
                                                                    ...
                                                                    ?>
                                                                            <tr id="<?php echo $diagnostic_alloted->date; ?>-<?php echo $diagnostic_alloted->payment_procedure; ?>">
                                                                                ...
                                                                                <?php if (empty($allotment->d_time) || $this->ion_auth->in_group(array('admin'))) { ?>
                                                                                    <td class="no-print" id="delete-diagnostic-<?php echo date('d') . '-' . $diagnostic_alloted->id; ?>"><button type='button' class='btn btn-danger btn-sm btn_width delete_diagnostic' title='<?php echo lang('delete'); ?>' data-toggle='' data-id="<?php echo $diagnostic_alloted->id . "**" . $diagnostic_alloted->payment_procedure; ?>"><i class='fa fa-trash'></i></button></td>
                                                                                <?php } ?>
                                                                            </tr>
                                                                    <?php
                                                                        }
