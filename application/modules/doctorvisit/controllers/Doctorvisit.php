    ...
    function getDoctorvisitList()
    {
        ...
        foreach ($data['doctorvisits'] as $doctorvisit) {
            ...
            if ($this->ion_auth->in_group(array('admin'))) {
                ...
                $options1 = '<a type="button" class="btn btn-primary btn-sm editbutton" title="' . lang('edit') . '" data-toggle="modal" data-id="' . $doctorvisit->id . '"><i class="fa fa-edit"></i> ' . lang('edit') . '</a>';
            }
