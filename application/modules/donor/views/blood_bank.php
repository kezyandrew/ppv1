                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($groups as $group) { ?>
                                        <tr class="">
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-primary btn-sm editbutton" title="<?php echo lang('edit'); ?>" data-toggle="modal" data-id="<?php echo $group->id; ?>"><i class="fa fa-edit"></i> </button>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
