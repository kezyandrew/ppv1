                                    ...
                                    foreach ($appointments as $appointment) {
                                        if ($user_id == $appointment->patient) {
                                            ...
                                            if ($appointment->status == 'Confirmed') {
                                                $options7 = '<a class="btn btn-info btn-sm btn_width detailsbutton buttoncolor" title="' . lang('start_live') . '"  href="meeting/instantLive?id=' . $appointment->id . '" target="_blank" onclick="return confirm(\'Are you sure you want to start a live meeting with the doctor?\');"><i class="fa fa-headphones"></i> ' . lang('live') . '</a>';
                                            } else {
                                                $options7 = '';
                                            }
