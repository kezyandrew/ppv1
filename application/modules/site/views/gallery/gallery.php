                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($gallerys as $gallery) { ?>
                                        <tr class="">
                                            ...
                                            <td class="no-print">
                                                <button type="button" class="btn btn-info btn-sm editbutton" title="<?php echo lang('edit'); ?>" data-toggle="modal" data-id="<?php echo $gallery->id; ?>"><i class="fa fa-edit"> </i></button>
