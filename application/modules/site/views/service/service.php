                    ...
                    <div class="card">
                        ...
                        <?php foreach ($services as $service) { ?>
                            ...
                            <td class="align-middle"><img class="img-fluid rounded-circle" style="width: 50px; height: 50px;" src="<?php echo $service->img_url; ?>"></td>
                                ...
                                <td class="no-print">
                                    <button type="button" class="btn btn-info btn-sm editbutton" title="<?php echo lang('edit'); ?>" data-toggle="modal" data-id="<?php echo $service->id; ?>"><i class="fa fa-edit"> </i></button>   
