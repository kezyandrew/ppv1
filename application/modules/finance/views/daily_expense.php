...
<link href="common/extranal/css/finance/daily_expense.css" rel="stylesheet">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>
                        <i class="fa fa-file-invoice"></i> <?php echo date('F Y', $first_minute); ?>
                        <?php if(isset($is_current_month) && $is_current_month): ?>
                            <span class="badge badge-danger"><?php echo lang('current_month'); ?></span>
                        <?php endif; ?>
                    </h1>
                    <p class="text-muted"><?php echo lang('hospital') . ' ' . lang('expense_report'); ?></p>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 mb-3">
                    <div class="small-box bg-warning">
                        <div class="inner">
                            ...
                            <p><?php echo lang('highest_expense'); ?>: <?php echo date('F', $first_minute); ?> <?php echo $highest_day; ?></p>
                        </div>
                        <div class="icon">
                        ...
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center flex-wrap">
                                ...
                                <div class="d-flex flex-wrap no-print">
                                    <?php if(!isset($is_current_month) || !$is_current_month): ?>
                                    <a href="finance/dailyExpense" class="btn btn-danger btn-sm mr-1">
                                        <i class="fa fa-calendar-day"></i> <?php echo lang('current_month'); ?>
                                    </a>
                                    <?php endif; ?>
                                    
                                    <a href="finance/dailyExpense?year=<?php echo $previous_year; ?>&month=<?php echo $previous_month; ?>" class="btn btn-outline-secondary btn-sm mr-1">
                                        <i class="fa fa-arrow-left"></i> <?php echo lang('previous'); ?>
                                    </a>
                                    
                                    <a href="finance/dailyExpense?year=<?php echo $next_year; ?>&month=<?php echo $next_month; ?>" class="btn btn-outline-secondary btn-sm mr-1">
                                        ...
                                        ?>
                                            <tr class="<?php echo $row_class; ?>" data-day="<?php echo $d; ?>">
                                                <td>
                                                    ...
                                                    if ($is_current_day) {
                                                        echo ' <span class="badge badge-danger">' . lang('today') . '</span>';
                                                    }
                                                    if ($is_highest_day) {
                                                        echo ' <i class="fas fa-exclamation-circle text-warning ml-2" title="' . lang('highest_expense') . '"></i>';
                                                    }
                                                    ?>
                                                </td>
...
<script type="text/javascript">
    ...
    var lang_highest_expense = "<?php echo lang('highest_expense'); ?>";
    ...
    var today_amount = <?php echo (isset($is_current_month) && $is_current_month && isset($all_expenses[date('D d-m-y')])) ? $all_expenses[date('D d-m-y')] : 0; ?>;
    ...
    var working_days_total = <?php echo $working_days_total; ?>;
    var working_day_average = <?php echo $working_day_average; ?>;
    var weekend_total = <?php echo $weekend_total; ?>;
    var weekend_day_average = <?php echo $weekend_day_average; ?>;
</script>

<script src="common/js/codearistos.min.js"></script>
<script src="common/extranal/js/finance/daily_expense_report.js"></script>
