                                        ...
                                        <div class="col-md-12 row">
                                            <div class="col-md-12 payment pad_bot">
                                                ...
                                                <select class="form-control m-bot15  pos_select" id="pos_select" name="patient" value='' required="">
                                                    ...
                                                    ?>
                                                        ...
                                                        <option style="color: red; font-size: 18px;" value="<?php echo 'add_new'; ?>"><?php echo lang('add_new'); ?></option>
                                                    <?php    } ?>
                                                </select>
                                            </div>
                                            ...
                                            <div class="pos_client row" style="display: none;">
                                                ...
                                                <div class="col-md-4 payment pad_bot">
                                                    <label for="exampleInputEmail1"> <?php echo lang(''); ?> <?php echo lang('gender'); ?></label>
