                                        ...
                                        <div class="col-md-12 row">
                                            <div class="col-md-12 payment pad_bot">
                                                ...
                                                <select class="form-control m-bot15" id="" name="patient" value='' required="">
                                                    ...
                                                    ?>
                                                    <option value="<?php echo $patient->id; ?>" selected="selected"><?php echo $patient->name; ?> ( <?php echo lang('id'); ?>: <?php echo $patient->id; ?> - <?php echo lang('phone'); ?>: <?php echo $patient->phone; ?> - <?php echo lang('age'); ?>: <?php echo $age[0]; ?> ) </option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="col-md-12 payment">
                                                <div class="form-group last">
                                                    <label for="exampleInputEmail1"> <?php echo lang('select'); ?> <?php echo lang('item'); ?> &ast; </label>
                                                    ...
                                                    <a target="_blank" href="finance/addPaymentCategoryView"><?php echo lang('add_new') ?> <?php echo lang('item') ?> ?</a>
                                                </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group cashsubmit">
                                                    <button type="submit" name="form_submit" value="save" id="submit1" class="btn btn-sm btn-primary btn-block float-left mb-1 mr-1"> <?php echo lang('save'); ?></button>
                                                </div>
                                                ...
                                                <div class="form-group cashsubmit2">
                                                    <button type="submit" name="form_submit" value="saveandprint" id="submit2" class="btn btn-sm btn-block btn-secondary float-left mb-1 mr-1"> <?php echo lang('save_and_print'); ?></button>
                                                </div>
                                                ...
                                                <?php if (empty($payment)) { ?>
                                                    <div class="form-group">
                                                        <button type="submit" name="form_submit" value="save_as_draft" id="save_as_draft" class="btn btn-sm btn-block btn-warning float-left mb-1 mr-1"> <?php echo lang('save_as_draft'); ?></button>
                                                    </div>
                                                <?php   } ?>
                                            </div>
