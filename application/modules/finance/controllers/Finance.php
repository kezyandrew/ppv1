...
class Finance extends MX_Controller
{
    ...
    function getPayment()
    {
        ...
        foreach ($data['payments'] as $payment) {
            ...
            $options2 = '<a class="btn btn-warning btn-sm invoicebutton mr-1 mt-1" title="' . lang('invoice') . '" style="color: #fff;" href="finance/invoice?id=' . $payment->id . '"><i class="fa fa-file-invoice"></i> ' . lang('invoice') . '</a>';
    ...
    function getExpense()
    {
        ...
        foreach ($data['expenses'] as $expense) {
            ...
            $options2 = '<a class="btn btn-success btn-sm invoicebutton" title="' . lang('invoice') . '" style="color: #fff;" href="finance/expenseInvoice?id=' . $expense->id . '"><i class="fa fa-file-invoice"></i> </a>';
